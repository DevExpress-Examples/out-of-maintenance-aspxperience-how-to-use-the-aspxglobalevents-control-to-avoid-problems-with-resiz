...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="InsertTableForm.ascx.vb" Inherits="InsertTableForm" %>
<%@ Assembly name="DevExpress.Data.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" %>
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor"
	TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors"
	TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel"
	TagPrefix="dxp" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor" TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dxp" %>
				...
				<tr>
					<td class="contentCell">
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<dxhe:ASPxHtmlEditorRoundPanel ID="rpSize" runat="server" Width="385px">
									...
									<!-- LAYOUT -->
									<dxhe:ASPxHtmlEditorRoundPanel ID="rpLayout" runat="server" Width="385px">
										<ContentPaddings PaddingTop="4px" />                                    
										<PanelCollection>
									...
									<!-- APPEARANCE -->                                                    
									<dxhe:ASPxHtmlEditorRoundPanel ID="rpAppearance" runat="server" Width="385px">
										<ContentPaddings PaddingTop="4px" />                                    
										<PanelCollection>
									...
									<dxhe:ASPxHtmlEditorRoundPanel ID="rpAccessibility" runat="server" ClientVisible="false" ClientInstanceName="_dxeRPAccessibility" Width="385px">
										<PanelCollection>
