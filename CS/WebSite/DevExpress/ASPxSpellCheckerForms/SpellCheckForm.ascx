...
<%@ Register Assembly="DevExpress.Web.ASPxSpellChecker.v10.1, Version=10.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxSpellChecker" TagPrefix="dxwsc" %>
                ...
                <table cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
                        <td align="right" class="leftBottomButton">
                            <dxe:ASPxButton ID="btnOptions" runat="server" Width="100px" AutoPostback="false" UseSubmitBehavior="false">
